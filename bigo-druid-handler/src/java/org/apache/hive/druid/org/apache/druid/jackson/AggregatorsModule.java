...
public class AggregatorsModule extends SimpleModule
{
  ...
  public AggregatorsModule()
  {
    ...
    if (ComplexMetrics.getSerdeForType("HLLSketch") == null) {
      ComplexMetrics.registerSerde("HLLSketch", new HllSketchMergeComplexMetricSerde());
    }
    if (ComplexMetrics.getSerdeForType("HLLSketchBuild") == null) {
      ComplexMetrics.registerSerde("HLLSketchBuild", new HllSketchBuildComplexMetricSerde());
    }
    if (ComplexMetrics.getSerdeForType("HLLSketchMerge") == null) {
      ComplexMetrics.registerSerde("HLLSketchMerge", new HllSketchMergeComplexMetricSerde());
    }
...
//
    setMixInAnnotation(AggregatorFactory.class, org.apache.druid.jackson.AggregatorsModule.AggregatorFactoryMixin.class);
    setMixInAnnotation(PostAggregator.class, org.apache.druid.jackson.AggregatorsModule.PostAggregatorMixin.class);
  }
  ...
  @JsonSubTypes(value = {
          ...
          @JsonSubTypes.Type(name = "HLLSketch", value = HllSketchAggregatorFactory.class),
          @JsonSubTypes.Type(name = "HLLSketchBuild", value = HllSketchBuildAggregatorFactory.class),
          @JsonSubTypes.Type(name = "HLLSketchMerge", value = HllSketchMergeAggregatorFactory.class)
  })
